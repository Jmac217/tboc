<style>
	.job_title{font-size:20px;text-decoration:underline;}
	.job_deadline{font-weight:bold;}
</style>
...
<div class='page_row textblock text_shadow box'>
	...
	<div class='sub_div'>
		...
		<p>
			We are seeking applicants for the position of full-time Customer Service Specialist. Responsibilities include, but are not limited to; greeting customers, handling phone and in-person inquiries, and providing assistance as needed to new accounts and bookkeeping. Prior banking experience preferred. Strong computer skills and customer service experience expected.
			<br/><br/>
			Benefits package includes 401K plan, health insurance and flexible ETO (Earned Time Off) policy. EOE.
			<br/><br/>
			Send resume by <span class='job_deadline'>September 8, 2014</span> to:
			<br/>
